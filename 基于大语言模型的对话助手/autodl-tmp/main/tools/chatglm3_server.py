...
MODEL_PATH = "F:\\competition\\autodl-tmp\\models\\ZhipuAI\\chatglm3-6b"
...
if __name__ == "__main__":
    ...
    # 获取 offload_folder 的绝对路径（这样可以避免相对路径可能带来的问题，确保路径准确）
    offload_folder_path = os.path.abspath(r'F:\competition\autodl - tmp\main\offload_weights')

    # 以下是原本报错的代码行，添加 offload_folder 参数进行修改
    model = AutoModel.from_pretrained(MODEL_PATH, trust_remote_code=True, device_map="auto",
                                      offload_folder=offload_folder_path).eval()
    # load Embedding
